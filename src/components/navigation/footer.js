...
import AppWithBack from "../../helpers/stateForApp";
...
const Footer = () => {
      ...
      <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p class="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500 dark:text-gray-400 sm:mx-0 sm:max-w-xs sm:text-left">
  ...
  return AppWithBack ? footerOne : footerTwo;
};
